(function() {
  ...
  module.exports = Server = (function() {
    ...
    Server.prototype.log_request = function(req) {
      if (this.log) {
    ...
    Server.prototype.log_response = function(data) {
      if (this.log) {
    ...
    Server.prototype.apps_top_fifty = function(req, res) {
      var _this = this;
    ...
    Server.prototype.app_quick_stats_day = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_quick_stats_week = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_quick_stats_month = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_web_requests = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_response_time = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_slowest_response = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_most_viewed = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_hardware_usage = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_bandwidth_days = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.app_bandwidth_month = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.make_it_pretty = function(number) {
      if (number < 10) {
        return 10;
      } else if (number < 500) {
    ...
    Server.prototype.component_quick_stats_day = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_quick_stats_week = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_quick_stats_month = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_web_requests = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_response_time = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_slowest_response = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
    ...
    Server.prototype.component_most_viewed = function(req, res) {
      var _this = this;
      this.log_request(req);
      res.header('Connection', 'close');
